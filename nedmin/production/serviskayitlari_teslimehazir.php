...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Teslime Hazır Olan Servis Kayıtları <small>(Teslime Hazır olan servis kayıtlarının tümü burada gösterilir..)</small></h2>
				...
				<div class="x_content">
					...
					<table id="datatableresponsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<?php 
							$bilgilerimsor=$db->prepare("SELECT * FROM yeniserviskayit where durum='teslime_hazir' ");
